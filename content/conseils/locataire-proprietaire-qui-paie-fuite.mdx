...
faq:
  - q: "Qui doit organiser la recherche de fuite quand on est locataire ?"
    a: "Le locataire qui constate la fuite doit la signaler rapidement au propriétaire et peut faire intervenir un professionnel de la détection sans attendre un accord préalable, pour limiter l'aggravation des dégâts. Le rapport technique établi ensuite sert de base pour déterminer la responsabilité."
  - q: "Le propriétaire peut-il refuser de payer si c'est de la vétusté ?"
    a: "Une fuite liée à la vétusté d'une installation relève en principe de l'obligation d'entretien du propriétaire. En cas de désaccord, le rapport de localisation précisant la cause probable de la fuite est la pièce qui permet de trancher."
  - q: "Quelle assurance dois-je prévenir en premier en tant que locataire ?"
    a: "Votre propre assurance habitation, qui couvre les risques locatifs. Informez également votre propriétaire ou son gestionnaire dès que possible, pour qu'il puisse mobiliser sa propre assurance si nécessaire."
  - q: "Que faire si mon propriétaire ne répond pas rapidement ?"
    a: "Ne retardez pas la recherche de fuite en attendant sa réponse : agissez pour limiter les dégâts et conservez une trace écrite de votre signalement (message, e-mail, courrier) ainsi que le rapport technique et les factures des interventions réalisées."
---
...
![Dossier fermé avec un stylo posé dessus sur une table](/conseils/locataire-proprietaire-01.jpg)
...
![Entrée d'un immeuble résidentiel avec porte et interphone](/conseils/locataire-proprietaire-02.jpg)
