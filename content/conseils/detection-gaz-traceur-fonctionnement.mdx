...
faq:
  - q: "Le gaz traceur est-il dangereux pour les occupants ou pour les canalisations ?"
    a: "Non. Le mélange azote/hydrogène utilisé est non toxique, non corrosif et non inflammable dans les proportions employées. Il se dissipe naturellement dans l'air sans laisser de résidu dans le circuit."
  - q: "Faut-il évacuer le logement pendant le test ?"
    a: "Non, ce n'est pas nécessaire. L'intervention se déroule normalement en présence des occupants, sans consigne de sécurité particulière liée au gaz."
  - q: "Le gaz traceur fonctionne-t-il sur tous les types de canalisation ?"
    a: "Il s'applique à la plupart des réseaux d'eau et de chauffage qui peuvent être mis hors eau et mis sous pression contrôlée. Selon la configuration, nous vous indiquons avant l'intervention si cette méthode est adaptée ou si une autre technique est préférable."
  - q: "Combien de temps dure un test au gaz traceur ?"
    a: "Cela dépend de la longueur du réseau et de la configuration du site, généralement entre 1 h et 3 h. Une estimation vous est donnée avant de commencer."
---
...
![Détecteur de gaz traceur tenu près d'une pelouse](/conseils/gaz-traceur-01.jpg)
...
![Détecteur de gaz portable utilisé près d'une plinthe à l'intérieur](/conseils/gaz-traceur-02.jpg)
